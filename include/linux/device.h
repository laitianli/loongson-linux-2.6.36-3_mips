...
struct bus_type {
	...
	struct device_attribute	*dev_attrs; /*挂在此总线上的所有设备的设备属性(每个设备共有的属性)*/
	struct driver_attribute	*drv_attrs; /*在总线上的所有驱动的共有的属性文件*/
	/*设备驱动的匹配接口*/
...
struct device {
	...
	struct list_head	devres_head;/*设备资源连表头*/

	struct klist_node	knode_class;/*设备类的连接件*/
	/*设备类*/
	struct class		*class;
	/*设备属性*/
