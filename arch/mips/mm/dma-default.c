...
dma_addr_t mips_unity_phys_to_dma32(struct device *dev, phys_addr_t paddr)
{
#ifdef CONFIG_CPU_LOONGSON2H
	return paddr | 0x40000000;
#else
...
phys_addr_t mips_unity_dma_to_phys32(struct device *dev, dma_addr_t daddr)
{
